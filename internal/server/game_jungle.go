...
func initialJungleBoard() [][]*types.JungleCell {
	...
	// 座位 A 下方（行 6–8），座位 B 上方（行 0–2）；双方不镜像：象对鼠、狮在各自右手。
	// B (top)
	placeJungle(board, 0, 0, types.SeatB, types.JungleTiger)
	placeJungle(board, 0, 6, types.SeatB, types.JungleLion)
	placeJungle(board, 1, 1, types.SeatB, types.JungleCat)
	placeJungle(board, 1, 5, types.SeatB, types.JungleDog)
	placeJungle(board, 2, 0, types.SeatB, types.JungleElephant)
	placeJungle(board, 2, 2, types.SeatB, types.JungleWolf)
	placeJungle(board, 2, 4, types.SeatB, types.JungleLeopard)
	placeJungle(board, 2, 6, types.SeatB, types.JungleRat)
	// A (bottom)
	placeJungle(board, 6, 0, types.SeatA, types.JungleRat)
	placeJungle(board, 6, 2, types.SeatA, types.JungleLeopard)
	placeJungle(board, 6, 4, types.SeatA, types.JungleWolf)
	placeJungle(board, 6, 6, types.SeatA, types.JungleElephant)
	placeJungle(board, 7, 1, types.SeatA, types.JungleDog)
	placeJungle(board, 7, 5, types.SeatA, types.JungleCat)
