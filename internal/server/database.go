...
var allSchemas = []string{
	chatSchema, roomEventLogSchema, punishmentEventSchema, pushSubscriptionSchema, playerSchema, activityEventSchema, petBondSchema, analyticsSchema, contributionSchema, genderSchema,
}
